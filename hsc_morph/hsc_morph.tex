...
\begin{figure*}[htb]
    \centering
    \includegraphics[width = 0.95\textwidth]{pred_true_all_z.png}
...
\begin{figure*}[htb]
    \centering
    \includegraphics[width = 0.95\textwidth]{gampen_v_simard.png}
...
\begin{figure*}[htb]
    \centering
    \includegraphics[width = 0.95\textwidth]{gampen_v_lenstronomy.png}
