...
\begin{figure*}[htb]
	\begin{center}
    \subfigure[]{\label{fig:candels_sn}\includegraphics[width=0.50\textwidth]{candels_sn.pdf}}
...
\begin{figure*}[htb]
	\begin{center}
    \subfigure[]{\label{fig:sdss_unclass_threshold}\includegraphics[width=0.41\textwidth]{sdss_unclass_threshold.pdf}}
    \subfigure[]{\label{fig:sdss_acc_threshold}\includegraphics[width=0.50\textwidth]{sdss_acc_threshold.pdf}}
  \end{center}
...
\begin{figure*}[htb]
	\begin{center}
    \subfigure[]{\label{fig:candels_acc_threshold_disk}\includegraphics[width=0.45\textwidth]{candels_acc_threshold_disk.pdf}}
    \subfigure[]{\label{fig:candels_acc_threshold_ellips}\includegraphics[width=0.45\textwidth]{candels_acc_threshold_ellips.pdf}}
  \end{center}
...
\begin{figure*}[htb]
	\begin{center}
    \subfigure[$z\sim0$ SDSS sample ]{\label{fig:ssfr_sdss}\includegraphics[width=0.47\textwidth]{ssfr_sdss.pdf}}
    \subfigure[$z\sim1$ CANDELS sample]{\label{fig:ssfr_candels}\includegraphics[width=0.48\textwidth]{ssfr_candels.pdf}}
  \end{center}
